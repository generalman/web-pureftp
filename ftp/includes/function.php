...
function information($var,$titre){
	...
	$chaine.=rand();
	echo ("<a href=\"#".$chaine."\" class=\"tooltiplink\"><img class=help border=0 src=\"/images/info.png\" height=\"18\" width=\"18\"></a>");			
	echo ("<div id=\"".$chaine."\" class=\"tooltip\">");
	echo ("<img class=help align=\"right\" src=\"/images/info.png\" height=\"60\" width=\"60\">");
